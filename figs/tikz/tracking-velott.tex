...
\begin{tikzpicture}
  ...
  \node[draw=none] at (2.65,0.05){\tiny $z$};
  ...
  \draw[thick,densely dashed,blue] (7,0) -- (7,4);
  ...
  \fill[blue,draw=black,opacity=0.75] (7.0,1.6) rectangle (7.2,1.8);
  \fill[blue,draw=black,opacity=0.75] (7.2,1.6) rectangle (7.4,1.8);
  \fill[blue,draw=black,opacity=0.75] (7.4,1.6) rectangle (7.6,1.8);
  \fill[blue,draw=black,opacity=0.75] (7.0,1.4) rectangle (7.2,1.6);

  \fill[blue,draw=black,opacity=0.75] (7.0,0.8) rectangle (7.2,1.);
  \fill[blue,draw=black,opacity=0.75] (7.0,2.2) rectangle (7.2,2.4);
  \fill[blue,draw=black,opacity=0.75] (7.0,2.6) rectangle (7.2,2.8);
  ...
  \draw[thick,densely dashed,blue] (10.5,1.75) -- (11.,1.75)  node[anchor=west] {\tiny Reference plane};
