...
\item If new particles exist, in NP models, they can also appear in the loop
...
\begin{frame}{The \lhcb experiment}
  \begin{itemize}
  \item LHCb is particle physics detector experiment located at the LHC 
...
\begin{itemize}
  \item Fit to invariant mass distribution required to separate our signal from background contributions
