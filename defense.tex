...
\begin{itemize}
 \item Decay fully described by \qsq, \mkpi and three angles $\Omega=(\ctl,\ctk,\phi)$
 \end{itemize}
...
\begin{tikzpicture}%[font=\boldmath]
 ...
 \begin{scope}[x={(image.south east)},y={(image.north west)}]
  %\draw[help lines,xstep=.1,ystep=.1] (0,0) grid (1,1);
  \node[draw=none] at (0.5,0.97) {\tiny 1330\textless\mkpi\textless1530\mevcc};
 \end{scope}
\end{tikzpicture}
\end{frame}
...
\begin{itemize}
  ...
  \item[$\blacktriangleright$] Common, cut based selection applied to select candidates of the form $\decay{\Bz}{X\mumu}$
...
%Slide
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle {Angular moments analysis}
