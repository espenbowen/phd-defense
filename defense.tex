...
\begin{frame}{Reminder: Rare decays as a probe for NP}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{itemize}
      \item The decay \BdToKpimm is an example of a flavour-changing-neutral-current \btosll processes that proceeds via loop diagrams in SM
        % \begin{itemize}
...
\begin{tikzpicture}
 ...
 \begin{scope}[x={(image.south east)},y={(image.north west)}]
  ...
  \draw[->,thick,blue] (0.75, 0.55) -- (0.75,0.35);
 \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{itemize}
\item Currently no SM prediction
\begin{itemize}
