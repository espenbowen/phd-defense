...
%Slide
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{VeloUT: Hit clustering}
\begin{columns}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item[$\blacktriangleright$] Now flat in \ptot
  \end{itemize}
...
\begin{frame}{Rare decays as a probe for New Physics}
  \begin{columns}
    ...
    \begin{myenv}{\color{bostonuniversityred}{NP}}[linecolor=bostonuniversityred]
      ...
      %\draw[help lines,xstep=.1,ystep=.1] (0,0) grid (1,1);
      \node[draw=none,bleudefrance] at (0.5,0.95) {\scriptsize \tquark};
      \node[draw=none,bostonuniversityred] at (0.25,0.6) {\scriptsize \Hm};
      \node[draw=none,bostonuniversityred] at (0.8,0.6) {\scriptsize \Hp};
      \node[draw=none,bleudefrance] at (0.5,0.45) {\scriptsize \Pnu};
      \end{scope}
      \end{tikzpicture}
    \begin{tikzpicture}
...
\node[draw=none] at (0.56,0.27) {\scriptsize \color{bleudefrance}{\Pgamma}\color{black}{,} \color{bostonuniversityred}{$\Z^{0}$}};
\end{scope}
\end{tikzpicture}
\begin{tikzpicture}
...
{\usebackgroundtemplate{\includegraphics[width=1.05\paperwidth]{figs/cavern.jpg}}
 ...
 \begin{frame}[plain]
 \vspace{8.5cm}
     \Huge\color{anti-flashwhite}{Backup Slides}
 \end{frame}
}
